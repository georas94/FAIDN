...
class __TwigTemplate_64d6778568ecf1764a1f025db889767f734bc27d62782823d0e36f671a095da3 extends Template
{
  ...
  <div class=\"row mt-5\">
    <div id=\"carouselHome\" class=\"carousel slide col-md-12\" data-ride=\"carousel\" data-interval=\"4000\">
      <div class=\"carousel-inner text-center\">
      ";
        // line 92
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["imagesSlider"]) || array_key_exists("imagesSlider", $context) ? $context["imagesSlider"] : (function () { throw new RuntimeError('Variable "imagesSlider" does not exist.', 92, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 93
            echo "          ";
            if (( !(null === twig_get_attribute($this->env, $this->source, $context["item"], "value", [], "any", false, false, false, 93)) && 1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["item"], "value", [], "any", false, false, false, 93)), 0))) {
                // line 94
                echo "            <div class=\"carousel-item\">
              <img src=\"";
                // line 95
                echo twig_escape_filter($this->env, ("assets/img/" . twig_get_attribute($this->env, $this->source, $context["item"], "value", [], "any", false, false, false, 95)), "html", null, true);
  ...
  <div class=\"row pt-5 justify-content-center \">
    <div id=\"citationCarousel\" class=\"carousel slide citationCarousel \" data-ride=\"carousel\" data-interval=\"7000\">
      ...
      ";
        // line 109
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["allCitations"]) || array_key_exists("allCitations", $context) ? $context["allCitations"] : (function () { throw new RuntimeError('Variable "allCitations" does not exist.', 109, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 110
            echo "        <div class=\"carousel-item\">
            <p class=\"text-center w-100 lead\">";
            // line 111
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["item"], "citation", [], "any", false, false, false, 111), "html", null, true);
            echo "<br> <small class=\"text-center w-100 font-italic\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["item"], "author", [], "any", false, false, false, 111), "html", null, true);
            echo "</small></p>
        </div>
      ";
        }
...
";
  ...
  ";
    ...
    {
        return array (  256 => 120,  246 => 119,  235 => 163,  233 => 119,  226 => 114,  215 => 111,  212 => 110,  208 => 109,  190 => 98,  184 => 95,  181 => 94,  178 => 93,  174 => 92,  135 => 55,  126 => 52,  122 => 51,  119 => 50,  115 => 49,  69 => 5,  59 => 4,  36 => 1,);
    }
...
<div class=\"container-fluid mt-5\">
  ...
  <div class=\"row mt-5\">
    <div id=\"carouselHome\" class=\"carousel slide col-md-12\" data-ride=\"carousel\" data-interval=\"4000\">
      <div class=\"carousel-inner text-center\">
      {% for item in imagesSlider %}
          {% if item.value is not null and item.value|length > 0%}
            <div class=\"carousel-item\">
              <img src=\"{{'assets/img/' ~ item.value}}\" class=\"img-fluid\" style=\"height:300px;width:700px\">
            </div>
          {% endif %}
      {% endfor %}        
      </div>
